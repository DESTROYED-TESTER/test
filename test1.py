...
def smile_random():
    ...
    if option in ['1','01','A','a']:bd()
    elif option in ['2','02','B','b']:ind()
    elif option in ['3','03','C','c']:npl()
    elif option in ['4','04','D','d']:pak()
    elif option in ['5','05','E','e']:nig()
...
def apv():
    url="https://raw.githubusercontent.com/MrSmile404/SMILE-/main/LUSH.txt"
    try:
        buffer = BytesIO()
        curl = pycurl.Curl()
    ...
    if num_key in datax:
        ...
        print(" !! Key - "+num_key)
        os.system("termux-open https://api.whatsapp.com/send?phone=+8801989733880&text=")
        sys.exit()
        apv()
menu()
    #apv()
