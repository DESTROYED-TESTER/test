...
def banner():
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  ceo&founder   : %s SUMON ROY                %s║"%(Z,B,M,Z))
	print("%s║%s  about   : Destroyed    %s║"%(Z,B,Z))
	print("%s║%s  tool :  premium %s║"%(Z,B,Z))
	print("%s║%s  Version  : %s101.5.0.10                          %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
...
def random_number():
	...
	print(f" {M}FOR EXAMPLE : {Z}[{H}+91838906XXXX{Z}]\n")
