...
def ___ERROR___():
    ...
    elif __ERROR__ in ['B','b','02','2']:os.system('xdg-open ');___ERROR___()
    else:
...
def ___RANDOM___():
    ...
    if error_ in ['A','a','01','1']:___INDIA___()
    elif error_ in ['B','b','02','2']:___BD___()
    elif error_ in ['C','c','03','3']:___NP___()
    else:___RANDOM___()
#====================[INDIA RANDOM]==========================
def ___INDIA___():
    clear()
