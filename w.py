...
def mbasic(uid,pwx,tl):
    ...
    try:
        for pw in pwx:
            ...
            cookies = {
            'dbln': '%7B%22100065411057062%22%3A%22z1A8YA7e%22%2C%22100052043861877%22%3A%22BowV5VW7%22%7D',
            'datr': 'fGxPag3RiWSCt4Q6UgJi4Y5U',
            'sb': 'fGxPaicC0xmf4XBDpCWYaI7S',
            'm_pixel_ratio': '2.4740447998046875',
            'ps_l': '1',
            'ps_n': '1',
            'fr': '0R31MVpuUX2HuJrDC.AWezYQL0eAz9zHlc6bpYqHphor9hzgApyOZzG_URQOF3awAk70M.BqTOjW..AAA.0.0.BqT2yN.AWcoJt3fuQOxep8rkoDfEOX_Si0',
            'dpr': '2.720080852508545',
            'wd': '990x1064',}
            headers = {
            ...
            'referer': 'https://www.facebook.com/VIP%20access',
