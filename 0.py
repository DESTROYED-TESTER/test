...
def mobile(uid,pwx,tl):
    ...
    "contact_point": uid
            ...
            "password_text_input_id": "custom:passid",
            "is_from_empty_password": 0,
            "ar_event_source": "login_home_page",
            "username_text_input_id": "custom:userid",
            "layered_homepage_experiment_group": "",
            "device_id": str(uuid.uuid4()),
            "INTERNAL__latency_qpl_instance_id": "0.123456789",
    ...
    'variables': json.dumps({
        "params": {
            "params": json.dumps({
                "client_input_params": json.dumps(client_input_params),
                "server_params": json.dumps(server_params)
            }),
    ...
    'client_trace_id': str(uuid.uuid4())
            ...
            'Host': 'b-graph.facebook.com',
            'X-FB-Connection-Type': 'MOBILE.LTE',
            'app-scope-id-header': '4f746ddb-70e8-41c9-ae74-ee20e96a4c3a',
            ...
            'x-tigon-is-retry': 'False',
            'x-fb-device-group': '520',
            'x-graphql-request-purpose': 'fetch',
            'X-ZERO-F-DEVICE-ID': '4f746ddb-70e8-41c9-ae74-ee20e96a4c3a',
            'X-FB-Friendly-Name': 'FbBloksActionRootQuery-com.bloks.www.bloks.caa.login.async.send_login_request',
            'User-Agent': '[FBAN/FB4A;FBAV/514.0.0.65.72;FBBV/737691764;FBDM/{density=2.7375,width=1080,height=2292};FBLC/en_US;FBRV/0;FBCR/Grameenphone;FBMF/TECNO;FBBD/TECNO;FBPN/com.facebook.katana;FBDV/TECNO CK7n;FBSV/14;FBOP/1;FBCA/arm64-v8a:;]',
