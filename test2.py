...
def rndmx(ids,pasx,tl):
        ...
        try:
                for pas in pasx:
                        ...
                        headers = {'User-Agent': 'FBAN/FB4A;FBAV/329.0.0.0.93;FBAV/70.0.0.2321;FBBV/4151313;FBAN/FB4A;FBAV/311.0.0.0.75;FBAV/70.0.0.2321;FBBV/4151313;FBDM/{density=1.0,width=320,height=568};FBLC/wo_SN;FBRV/395097061;FBCR/Visible;FBMF/Google Assistant (2075);FBBD/Google Assistant (2023);com.facebook.gameroom;FBDV/Google Pixel Slate;FBSV/75;FBOP/140;FBCA/arm64-v8a;FBMF/Realme;FBBD/Realme GT 2 Pro;FBSV/12;FBDM/{density=3.0,width=1440,height=3200};FBLC/en_US;FBRV/228792653;FBCR/T-Mobile', 'Accept-Encoding': 'gzip, deflate', 'Connection': 'Keep-Alive', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': str(random.randint(20000, 40000)), 'X-FB-SIM-HNI': str(random.randint(20000, 40000)), 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32'}
