 ...
 try:
  for ps in pwv:
   ...
   header_freefb ={
    ...
    "Content-Length": "142",
    "Content-Type": "application/x-www-form-urlencoded",
    "Cookie": "dbln=%7B%2261558667962860%22%3A%22kGkQiThx%22%7D; ps_n=1; ps_l=1; locale=en_GB; datr=cmZgZnHhDDWGAFweAUCEU7Sx; sb=cmZgZg3hMc_bITA-0AJrqxmL; fr=0jNfmOgt36OtreBrb.AWXxuTsZboMxQbGZkbKj44feBgE.BmYGZ0..AAA.0.0.BmZdG6.AWWb0Mqx8FY; wd=1440x773",
    "Dpr": "1",
