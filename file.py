...
def ATOM():
    ____banner____()
    print(f'{rad}[{white}A{rad}]{rad}[{white}1{rad}]\033[1;37m--- FILE CLONE')
    print(f'{rad}[{white}B{rad}]{rad}[{white}2{rad}]\033[1;37m--- MAIL CLONE')
    print(f'{rad}[{white}C{rad}]{rad}[{white}3{rad}]\033[1;37m--- RANDOM CLONE')
