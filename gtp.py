...
cookies = {
    ...
    '__cf_bm': '1VqN2fBKqnvA10VBTrhNuiV6lwOb6Y7F_XB.iob6FM8-1760723542-1.0.1.1-btaaYniH4uuEjWYhMvtShnE.W0fvfz23i0b.8XWjadLvtks4Dg_SsGhKxXrCxiK9gwzS4a9d8O9Z4k8ik86CKSdkQ4XA6f6SNHwO85ltLvk',
    '_ga_3MT5TWB94N': 'GS2.1.s1760698322$o1$g1$t1760698093$j60$l0$h0',
...
response = requests.post('https://api.tensor.art/community-web/v2/post/update', cookies=cookies, headers=headers, json=json_data)
