...
bio_text = "https://www.imdb.com/user/ur205123734/"
...
response = requests.post('https://cdn.prod.metrics.imdb.com/', cookies=cookies, headers=headers, json=json_data)#https://api.graphql.imdb.com/
